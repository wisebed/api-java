...
public interface WSN {
     ...
     * @param nodeUrns
     * @return
     *     returns java.util.List<eu.wisebed.api.wsn.ChannelPipelinesMap>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getChannelPipelines", targetNamespace = "urn:WSNService", className = "eu.wisebed.api.wsn.GetChannelPipelines")
    @ResponseWrapper(localName = "getChannelPipelinesResponse", targetNamespace = "urn:WSNService", className = "eu.wisebed.api.wsn.GetChannelPipelinesResponse")
