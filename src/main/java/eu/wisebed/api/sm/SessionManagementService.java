    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(eu.wisebed.api.sm.SessionManagementService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = eu.wisebed.api.sm.SessionManagementService.class.getResource(".");
